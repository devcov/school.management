    ...
    <div class="col-xl-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <button type="button" class="btn  btn-primary x-small" data-toggle="modal" data-target="#exampleModal"
                    >
                    {{ trans('My_Classes_trans.add_class') }}
                </button>

                <button type="button" class="btn  btn-primary x-small" id="btn_delete_all">
                ...
                <form action="{{ route('Filter_Classes') }}" method="POST">
                    ...
                    <select class="selectpicker" data-style="btn-info" name="Grade_id" required
                        style="border-radius: 30%" onchange="this.form.submit()">
